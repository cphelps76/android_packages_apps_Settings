...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private int getCurrentLeftRate() {
        ...
        /*if (savedValue == 100) {
            ...
            Log.d(TAG, "currentLeftRate=" + (int) curVal);
            return ((int) curVal);
        }*/
        return savedValue;
    }
    ...
    private int getCurrentTopRate() {
        ...
        /*if (savedValue == 100) {
            ...
            Log.d(TAG, "currentTopRate=" + (int) curVal);
            return ((int) curVal);
        }*/
        return savedValue;
    }
    ...
    private int getCurrentRightRate() {
        ...
        Log.d(TAG, "saved right value " + savedValue);
        /*if (savedValue == 100) {
            float offset = (zoomStep * zoomStepWidth) / (mRight + 1);
            float curVal = MAX_WIDTH - offset;
            Log.d(TAG, "currentRightRate=" + (int) curVal);
            return ((int) curVal);
        }*/
        return savedValue;
    }
    ...
    private int getCurrentBottomRate() {
        ...
        Log.d(TAG, "Saved bottom value " + savedValue);
        /*if (savedValue == 100) {
            float offset = mBottom / zoomStep;
            float curVal = MAX_WIDTH - offset;
            Log.d(TAG, "currentBottomRate=" + (int) curVal);
            return ((int) curVal);
        }*/
        return savedValue;
    }
    ...
    private void showPositionDialog(Context context) {
        ...
        final NumberPicker mLeftPicker = (NumberPicker) dialog.findViewById(R.id.left_picker);
        ...
        final NumberPicker mTopPicker = (NumberPicker) dialog.findViewById(R.id.top_picker);
        ...
        final NumberPicker mRightPicker = (NumberPicker) dialog.findViewById(R.id.right_picker);
        ...
        final NumberPicker mBottomPicker = (NumberPicker) dialog.findViewById(R.id.bottom_picker);
        ...
        mBottomPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                if (oldVal > newVal) {
                    //zoom out
                    zoomOut(mBottomPicker);
                } else {
                    // zoom in
                    zoomIn(mBottomPicker);
                }
